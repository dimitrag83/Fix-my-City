...
public class HttpPostAsyncTask extends AsyncTask<List, Void, Integer>{

	Context c;
	
	public HttpPostAsyncTask(Context ac)
	{
		c=ac;
	}
	...
	protected Integer doInBackground(List... params) {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://150.140.15.50/sdy51/2014/senddata.php"); //se poio service 8a steiloume ta dedomena me POST
	...
	protected void onPostExecute(Integer result) {
		...
		if(result==200)
			Toast.makeText(c, "Data uploaded Successfully!", Toast.LENGTH_LONG).show();
		else
			Toast.makeText(c, "Data failed to upload! Code was "+result, Toast.LENGTH_LONG).show();
    }
